...
import net.huhandhacker.daggermod.recipebookcomponents.ForgeRecipeBookComponent;
...
public class AbstractForgeScreen<T extends AbstractForgeMenu> extends AbstractRecipeBookScreen<T> {

    private final Identifier texture;
    private final Identifier litProgressSprite;
    private final Identifier burnProgressSprite;

    public AbstractForgeScreen(
            final T menu,
        ...
        super(menu, new ForgeRecipeBookComponent(menu, recipeFilterName, tabInfos), inventory, title);
    ...
    public void extractBackground(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final float a) {
        ...
        if (this.menu.isLit()) {
            ...
            graphics.blitSprite(
                    RenderPipelines.GUI_TEXTURED, this.litProgressSprite, 14, 14, 0, 14 - litProgressHeight, xo + 56, yo + 36 + 14 - litProgressHeight, 14, litProgressHeight
            );
        }
