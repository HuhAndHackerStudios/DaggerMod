...
import net.huhandhacker.daggermod.fuelslot.ForgeFuelSlot;
...
public class AbstractForgeMenu extends RecipeBookMenu {
    ...
    protected AbstractForgeMenu(
        ...
        this.addSlot(new ForgeFuelSlot(this, container, 1, 56, 53));
    ...
    public RecipeBookMenu.PostPlaceAction handlePlacement(
        ...
        return ServerPlaceRecipe.placeRecipe(new ServerPlaceRecipe.CraftingMenuAccess<AbstractCookingRecipe>() {
            @Override
            public void fillCraftSlotsStackedContents(final StackedItemContents stackedContents) {
                AbstractForgeMenu.this.fillCraftSlotsStackedContents(stackedContents);
            }
            ...
            public boolean recipeMatches(final RecipeHolder<AbstractCookingRecipe> recipe) {
                return recipe.value().matches(new SingleRecipeInput(AbstractForgeMenu.this.container.getItem(0)), level);
            }
