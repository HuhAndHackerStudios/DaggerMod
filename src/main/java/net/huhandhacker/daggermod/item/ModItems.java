...
public class ModItems {
    ...
    public static final Item BRITTLE_SHARKTOOTH_DAGGER = registerItem("brittle_sharktooth_dagger", properties -> new DaggerItem(properties.durability(3).stacksTo(1).rarity(Rarity.EPIC)));
